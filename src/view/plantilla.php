...
if ($vista == "login" || $vista == "404" || $vista == "reset-password") {
    ...
    if ($vista != './src/view/imprimir-movimiento.php' && $vista != './src/view/reporte-bienes.php' && $vista != './src/view/imprimir-movimientos.php' && $vista != './src/view/imprimir-bienes.php' && $vista != './src/view/imprimir-instituciones.php'
    && $vista != './src/view/imprimir-movimientos.php' && $vista != './src/view/imprimir-usuario.php') {
